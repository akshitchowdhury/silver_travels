...
const TestimonialCard = ({ text, author,  Place, image }) => {
  ...
  <div className="max-w-screen-md mx-auto px-4 py-8 lg:py-16 lg:px-6">
    <div className="max-w-md mx-auto bg-sky-200 dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
      <div className="flex items-center justify-center bg-rose-400 dark:bg-gray-700 py-4">
        <img className="h-12 w-12 rounded-full object-cover mr-2" src={image} alt="Profile Image" />
        <h2 className="text-lg font-semibold text-white dark:text-white">{author}</h2>
      </div>
