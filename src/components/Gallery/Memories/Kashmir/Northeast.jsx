...
import a2 from '../../../../assets/galleryMemories/bt2.jpg'
import a3 from '../../../../assets/galleryMemories/bt3.jpg'
  ...
  return (
    ...
    <div className='kashmir' style={{ height: 'auto', padding: '2%', }}>
      ...
      <div
        ...
        style={{  padding: "6%", marginTop: '2%',borderRadius: '2%', backgroundImage: 'linear-gradient(to bottom right, #C2BFB5, #66CAF1)'}}
      >
        <p
